...
def part2_one_pose(viewer, bvh_file_path):
    ...
    joint_positions, joint_orientations = part2_forward_kinematics(joint_name, joint_parent, joint_offset, motion_data, 1200)
...
def main():
    # create a viewer
    viewer = SimpleViewer()
    bvh_file_path = "data/dance.bvh"
    # bvh_file_path = "data/Apose_crawl.bvh"
    ...
    # part3
    part3_retarget(viewer, "data/dance.bvh", "data/APose_crawl.bvh")
