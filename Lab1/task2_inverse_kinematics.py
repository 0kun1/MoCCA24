...
from Lab2_IK_answers_CCD import *
class MetaData:
...
def part2(viewer, bvh_name):
    ...
    class UpdateHandle:
        ...
        def update_func(self, viewer):
            ...
            joint_position, joint_orientation = part2_inverse_kinematics(self.meta_data, joint_position, joint_orientation, 0.35, 0.25, 1.3)
